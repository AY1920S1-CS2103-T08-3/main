...
Format: `addCompetition c/COMPETITION NAME startDate/START DATE OF COMPETITION endDate/END DATE OF COMPETITION`

Example:
`addCompetition c/IPF World Championships startDate/12/02/1995 endDate/15/02/1995`
