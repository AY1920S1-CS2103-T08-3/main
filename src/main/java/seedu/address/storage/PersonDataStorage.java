...
public interface PersonDataStorage {
     ...
     */
    Optional<ReadOnlyPersonData> readAddressBook() throws DataConversionException, IOException;

    /**
     * @see #getAddressBookFilePath()
     */
    Optional<ReadOnlyPersonData> readAddressBook(Path filePath) throws DataConversionException, IOException;
