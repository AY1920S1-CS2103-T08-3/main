...
public class StorageManager implements Storage {
    ...
    public Path getAddressBookFilePath() {
        return personDataStorage.getAddressBookFilePath();
    }

    @Override
    public Optional<ReadOnlyPersonData> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(personDataStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyPersonData> readAddressBook(Path filePath) throws DataConversionException, IOException {
        logger.fine("Attempting to read data from file: " + filePath);
        return personDataStorage.readAddressBook(filePath);
    }

    @Override
    public void saveAddressBook(ReadOnlyPersonData addressBook) throws IOException {
        saveAddressBook(addressBook, personDataStorage.getAddressBookFilePath());
    }
